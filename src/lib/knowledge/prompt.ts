...
- When the question covers multiple projects or areas and context has sections for each, structure the answer per project/area (bullets or short paragraphs). Cover every area asked about if context supports it.
